...
export declare function enumerateContents(content: Document | Document[], renderOption?: RenderOption, renderEmbed?: (metadata: Metadata) => EmbeddedItem | EntryNode): string | string[];
export declare function textNodeToHTML(node: TextNode, renderOption: RenderOption): string;
